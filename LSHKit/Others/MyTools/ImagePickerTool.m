    ...
    if (_imagePicker == nil) {
        if (_isCamera) {//相机
            if (![UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]) {
                ...
                [MyTools showAlertWithTitle:nil andContent:kLocStr(@"没有可以使用的相机!") andBlock:nil atController:_vc];
            ...
            if (![UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypePhotoLibrary]) {
                ...
                [MyTools showAlertWithTitle:nil andContent:kLocStr(@"没有可以使用的相册!") andBlock:nil atController:_vc];
...
-(void)open
{
    ...
    if (_isCamera) {
        ...
        if (authStatus == AVAuthorizationStatusRestricted || authStatus ==AVAuthorizationStatusDenied)
        {
            //无权限
            NSLog(@"照相服务没有打开");
            [MyTools showAlertWithTitle:nil andContent:@"照相机服务没有打开,是否前往打开?" andSureBlock:^{
            ...
            } andCancelBlock:nil andSureTitle:@"是" andCancelTitle:@"否" atController:_vc];
        }else{
        ...
        if (status == PHAuthorizationStatusRestricted ||
            ...
            [MyTools showAlertWithTitle:nil andContent:@"相册权限没有打开,是否前往打开?" andSureBlock:^{
